$(function (){
  ...
  // section5
  $("#section5 .big li").on("click", function () {
    i = $(this).index();
    $("#section5 .small li").css({ opacity: "0" });
    $("#section5 .small li").eq(i).css({ opacity: "1" });
    $("#section5 .big li:first-child").css({ animation: "none" });
  });
